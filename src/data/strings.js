...
export const STRINGS = {
  es: {
    ...
    death_barrera: 'El callejon estaba cerrado',
    // EL FILO (PLAN_MISION_CINCO_FASES §11.3): te subiste de la banda y el radar te completo.
    death_pintado: 'Te vieron subir',
    // EL ATERRIZAJE (PLAN_MISION_CINCO_FASES §4)
    land_call: 'CORTA FINAL', land_gear_down: 'TREN ABAJO', land_gear_up: 'TREN ARRIBA',
    land_perfecto: 'TOMA DE MANUAL', land_ok: 'EN CASA', land_mal: 'LLEGASTE, Y ES LO QUE IMPORTA',
    res_land: 'ATERRIZAJE',
    ...
    death_eyecto_rescate: 'Te quedaste sin combustible. Te eyectaste cerca de la costa y te sacaron del agua',
    death_eyecto_mar: 'Te quedaste sin combustible. Te eyectaste en mar abierto y el Atlantico Sur no perdona',
    seco_radio: '{c}: ME ESTOY QUEDANDO SIN COMBUSTIBLE. ESTOY CON LA RESERVA, VUELVO.',
    ...
    tip1: 'Mas bajo = mas puntos. Esquivar al ras da bonus.',
    ...
    // MODELO DE SALUD / AVERIAS (core/damage.js)
    ...
    optBarreras: 'BARRERAS EN EL CALLEJON',
    optBarreras_0: 'NINGUNA', optBarreras_1: 'POCAS', optBarreras_2: 'MUCHAS',
    optNoteBarreras: 'Cierran el pasillo de lado a lado: se pasan por arriba o por abajo. Solo con laderas de los DOS lados.',
    ...
    optHudAuto: 'TABLERO', optHudFijo: 'COMPLETO', optHudPorDemanda: 'POR DEMANDA',
    ...
    radarEntra: 'ENTRANDO EN RADAR — AL AGUA', radarSale: 'FUERA DE RADAR — A SUBIR',
  ...
  en: {
    ...
    death_barrera: 'The alley was blocked',
    death_pintado: 'They saw you climb',
    land_call: 'SHORT FINAL', land_gear_down: 'GEAR DOWN', land_gear_up: 'GEAR UP',
    land_perfecto: 'TEXTBOOK LANDING', land_ok: 'HOME', land_mal: 'YOU MADE IT BACK',
    res_land: 'LANDING',
    ...
    death_eyecto_rescate: 'You ran out of fuel. You ejected near the coast and they pulled you out of the water',
    death_eyecto_mar: 'You ran out of fuel. You ejected over open sea and the South Atlantic does not forgive',
    seco_radio: '{c}: I\'M RUNNING OUT OF FUEL. I\'M ON RESERVE, HEADING BACK.',
    ...
    hud_home: 'HOME',
    hud_fuera_radar: 'OUT OF RADAR', hud_zona_radar: 'RADAR ZONE', hud_detectando: 'DETECTING...',
    radarEntra: 'ENTERING RADAR — GET DOWN', radarSale: 'OUT OF RADAR — CLIMB',
    ...
    optBarreras: 'ALLEY BARRIERS',
    optBarreras_0: 'NONE', optBarreras_1: 'FEW', optBarreras_2: 'MANY',
    optNoteBarreras: 'They close the corridor across: you go over or under. Only with hillsides on BOTH sides.',
    ...
    optHudAuto: 'PANEL', optHudFijo: 'FULL', optHudPorDemanda: 'ON DEMAND',
