...
export const STRINGS = {
  es: {
    ...
    optYes: 'SI', optNo: 'NO',
    optMira: 'MIRA', optMoves: 'PIRUETAS',
    ...
    ctrlGun: 'CAÑON',           ctrlGunK: 'X · ESPACIO · K',    ctrlGunP: '✕',
    ctrlMsl: 'MISIL',           ctrlMslK: 'Z   ·   TAB',        ctrlMslP: '▢',
    ctrlBoost: 'TURBO',         ctrlBoostK: 'SHIFT   ·   C',    ctrlBoostP: 'gatillo',
    ctrlMoves: 'PIRUETAS',      ctrlMovesK: 'secuencias ← → ↑ ↓', ctrlMovesP: 'stick o cruceta',
    ctrlRoll: 'GIRO LIBRE 360°', ctrlRollK: 'Q   ·   E',        ctrlRollP: '—',
    ctrlAim: 'MIRA libre/fija', ctrlAimK: 'CAPS LOCK · mouse',  ctrlAimP: 'R1 · stick der',
    ctrlCam: 'CAMARA',          ctrlCamK: 'V',                  ctrlCamP: '—',
    ctrlInv: 'INVERTIR EL GAS', ctrlInvK: '—',                  ctrlInvP: 'L1',
    ...
    arena_hint: 'VOLA CON ← → · GAS ↑ · PICA ↓ · [X] FUEGO [Z] MISIL · [V] CAMARA',
  ...
  en: {
    ...
    optYes: 'YES', optNo: 'NO',
    optMira: 'SIGHT', optMoves: 'MANEUVERS',
    ...
    ctrlGun: 'CANNON',          ctrlGunK: 'X · SPACE · K',      ctrlGunP: '✕',
    ctrlMsl: 'MISSILE',         ctrlMslK: 'Z   ·   TAB',        ctrlMslP: '▢',
    ctrlBoost: 'BOOST',         ctrlBoostK: 'SHIFT   ·   C',    ctrlBoostP: 'trigger',
    ctrlMoves: 'MANEUVERS',     ctrlMovesK: '← → ↑ ↓ sequences', ctrlMovesP: 'stick or d-pad',
    ctrlRoll: 'FREE 360° ROLL', ctrlRollK: 'Q   ·   E',         ctrlRollP: '—',
    ctrlAim: 'SIGHT free/fixed', ctrlAimK: 'CAPS LOCK · mouse', ctrlAimP: 'R1 · right stick',
    ctrlCam: 'CAMERA',          ctrlCamK: 'V',                  ctrlCamP: '—',
    ctrlInv: 'INVERT THROTTLE', ctrlInvK: '—',                  ctrlInvP: 'L1',
    ...
    arena_hint: 'FLY WITH ← → · THROTTLE ↑ · DIVE ↓ · [X] FIRE [Z] MISSILE · [V] CAMERA',
