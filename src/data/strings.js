...
export const STRINGS = {
  es: {
    ...
    ctrlCam: 'CAMARA',          ctrlCamK: 'V',                  ctrlCamP: 'cruceta ABAJO',
    ctrlTempo: 'MOMENTUM (camara lenta)', ctrlTempoK: '4',      ctrlTempoP: '—',
    ctrlChancha: 'LA CHANCHA (reabastecer)', ctrlChanchaK: '5', ctrlChanchaP: '—',
  ...
  en: {
    ...
    ctrlCam: 'CAMERA',          ctrlCamK: 'V',                  ctrlCamP: 'd-pad DOWN',
    ctrlTempo: 'MOMENTUM (slow motion)', ctrlTempoK: '4',       ctrlTempoP: '—',
    ctrlChancha: 'THE TANKER (refuel)', ctrlChanchaK: '5',      ctrlChanchaP: '—',
