...
export const ICONOS = {
  ...
  // LOS CUATRO DEL VUELO (11/9): velocidad, Mach, altitud y gas.
  vel: { letra: 'V', png: null, pix: [                          // dos cheurones: para adelante, rapido
    '#...#..',
    '.#...#.',
    '..#...#',
    '.#...#.',
  ...
  alt: { letra: 'H', png: null, pix: [                          // una flecha que sube desde el agua
    '...#...',
    '..###..',
    '.#.#.#.',
    '...#...',
  ...
  gas: { letra: 'G', png: null, pix: [                          // la palanca: bocha, vara y la ranura
    '.###.',
    '.###.',
    '..#..',
    '..#..',
  ...
  sena_recibido: { letra: 'R', png: null, pix: [   // recibido: la tilde
    '.........', '........#', '.......##', '......##.', '#....##..', '##..##...', '.####....', '..##.....', '.........',
  ] },
  // EL PACK DE SEÑALES (data/senales.js): los pictogramas de TUS señas
  senal_panza: { letra: 'P', png: null, pix: [     // mirame: el ojo
    '.........', '.........', '..#####..', '.#.....#.', '#..###..#', '#..###..#', '.#.....#.', '..#####..', '.........',
  ] },
  senal_abajo: { letra: 'V', png: null, pix: [     // mas abajo: la flecha al agua
    '...###...', '...###...', '...###...', '...###...', '#########', '.#######.', '..#####..', '...###...', '....#....',
  ] },
  senal_rompo_d: { letra: '>', png: null, pix: [   // rompo a la derecha
    '....#....', '....##...', '....###..', '########.', '#########', '########.', '....###..', '....##...', '....#....',
  ] },
  senal_rompo_i: { letra: '<', png: null, pix: [   // rompo a la izquierda
    '....#....', '...##....', '..###....', '.########', '#########', '.########', '..###....', '...##....', '....#....',
  ] },
  senal_alerta: { letra: '!', png: null, pix: [    // alerta
    '...###...', '...###...', '...###...', '...###...', '...###...', '....#....', '.........', '...###...', '...###...',
  ] },
