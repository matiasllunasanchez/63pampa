...
- **Doble franja de conducción en la deriva** — la marca reglamentaria del jefe de
  escuadrilla. Pintada perfecta, enmascarada con cinta, sin un pelo fuera.
...
**Marca de sprite (20 px):** las dos franjas oscuras en la cola.
...
Master reference sheet of an A-4B Skyhawk attack jet, full side profile on a
plain light background. Bare silver-grey metal, the CLEANEST and most immaculate
aircraft of the squadron: perfectly aligned panels, no streaks, no stains,
regulation finish. TWO neat dark command stripes painted across the tail fin,
masked and crisp. Below the cockpit, a short row of small white stars painted in
...
Master reference sheet of an A-4B Skyhawk attack jet, full side profile on a
plain light background. Bare silver-grey metal, well-used and cheerfully scruffy:
...
Master reference sheet of an A-4B Skyhawk attack jet, full side profile on a
plain light background. The OLDEST and most weathered airframe of the squadron:
...
Master reference sheet of an A-4B Skyhawk attack jet, full side profile on a
plain light background. A REBUILT patchwork airframe: silver-grey metal with
several mismatched replacement panels in slightly different shades, one wing
panel still in flat GREEN primer, unpainted. Faint half-erased carpenter-pencil
...
| `{SKYHAWK_PICHON}` | A-4B Skyhawk, rebuilt patchwork airframe with mismatched panels, one wing panel in flat green primer, faint pencil marks on panels, small non-standard fairings, only two or three white stars |
