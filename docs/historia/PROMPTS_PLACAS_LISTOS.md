...
## 1. A1 · `linea_amanecer` — la línea de vuelo, amanecer

**Guardar como:** `assets/plates/linea_amanecer.png`
...
Wide view of a windswept Patagonian airbase flightline at dawn in 1982:
...
## 2. A2 · `linea_atardecer` — la línea de vuelo, atardecer

**Guardar como:** `assets/plates/linea_atardecer.png`
...
The exact same Patagonian airbase flightline and camera angle, now at dusk:
...
## 3. A3 · `linea_noche` — la línea de vuelo, noche

**Guardar como:** `assets/plates/linea_noche.png`
...
The exact same Patagonian airbase flightline and camera angle, now at night:
the same cracked concrete apron, the same fuel bowser and ground-power cart, the same
...
## 4. A4 · `hangar_dia` — el hangar por dentro, de día

**Guardar como:** `assets/plates/hangar_dia.png`
...
Interior of a corrugated-metal aircraft hangar in daylight, 1982: a wheeled
...
## 5. A5 · `hangar_noche` — el hangar de noche, con lámpara

**Guardar como:** `assets/plates/hangar_noche.png`
...
The exact same corrugated-metal hangar interior and camera angle, now at
...
## 6. A6 · `vestuario` — el vestuario, penumbra

**Guardar como:** `assets/plates/vestuario.png`
...
Interior of a spartan military changing room at night, 1982: a row of tall
...
## 7. A7 · `radio` — la sala de radio

**Guardar como:** `assets/plates/radio.png`
...
Interior of a small military radio room, 1982: a bank of olive-green valve
...
## 8. A8 · `cocina_calida` — la cocina de Norma, 1982

**Guardar como:** `assets/plates/cocina_calida.png`
...
## 9. A9 · `cocina_gris` — la misma cocina, lavada

**Guardar como:** `assets/plates/cocina_gris.png`
...
## 10. A10 · `fogon` — el fogón detrás del hangar

**Guardar como:** `assets/plates/fogon.png`
...
Behind a corrugated-metal hangar at night, 1982: an oil drum cut in half
...
## 11. A11 · `cabina_dia` — la cabina por dentro, de día

**Guardar como:** `assets/plates/cabina_dia.png`
...
Interior of a 1950s single-seat attack jet cockpit seen from the pilot's
...
## 12. A12 · `cabina_noche` — la cabina de noche

**Guardar como:** `assets/plates/cabina_noche.png`
...
The exact same 1950s jet cockpit interior and camera angle, now at night: the
...
## 13. A13 · `pista_lluvia` — la pista bajo la lluvia

**Guardar como:** `assets/plates/pista_lluvia.png`
...
View out across a Patagonian airbase apron in heavy rain, 1982, seen from
...
## 14. A14 · `jazminero` — el patio con el jazminero

**Guardar como:** `assets/plates/jazminero.png`
...
A small back patio of a modest Argentine house on a warm afternoon: a
...
## 15. A15 · `tandil` — la plataforma de Tandil, amanecer helado

**Guardar como:** `assets/plates/tandil.png`
...
A military airbase apron at Tandil, Buenos Aires province, at first light on
...
## 16. A16 · `museo` — el museo escolar, presente

**Guardar como:** `assets/plates/museo.png`
...
Interior of a small school museum room in the present day: a glass display
...
## 17. B1 · `p4_hoja` — la hoja vacía

**Guardar como:** `assets/plates/p4_hoja.png`
...
## 18. C1 · `m7_foto_frente` — la foto de la bella dama

**Guardar como:** `assets/plates/m7_foto_frente.png`
...
Extreme close-up of a small worn late-1950s black-and-white photograph taped
...
## 19. C2 · `m7_foto_dorso` — el dorso

**Guardar como:** `assets/plates/m7_foto_dorso.png`
...
Extreme close-up of the BACK of a small worn late-1950s photograph, held
...
## 20. C4 · `m10_mirage_fila` — los diez Mirage, las cúpulas vacías

**Guardar como:** `assets/plates/m10_mirage_fila.png`
...
Ten identical delta-wing fighter jets parked in a neat row on a frosted
...
## 21. C5 · `m12_tallado` — el VAMOS A VOLVER tallado en la viga

**Guardar como:** `assets/plates/m12_tallado.png`
...
Extreme close-up of a rough wooden beam shoring up the wall of a muddy
...
## 22. C6 · `m13_carta_locker` — la carta contra el fondo del locker

**Guardar como:** `assets/plates/m13_carta_locker.png`
...
EXTREME CLOSE-UP taken from right in front of the open door of ONE personal
...
## 23. C7 · `final_monte` — el monte apagado

**Guardar como:** `assets/plates/final_monte.png`
...
Aerial view looking down at a low peat hillside at dawn from a low-flying
...
## 24. C8 · `mesa_dos_papeles` — los dos papeles enfrentados

**Guardar como:** `assets/plates/mesa_dos_papeles.png`
...
Overhead close-up of a formica kitchen table with a plastic tablecloth,
...
## 25. m9_libreta — de PROMPTS_HOJAS_PERSONAJE.md

**Guardar como:** `assets/plates/m9_libreta.png`
...
Extreme close-up of a fat black oilcloth-covered pocket notebook lying open
