...
| **Dedication Pass** (pasada de homenaje, baja y lenta, con batido de alas) | sí | **cinemática de m8 «El batir de las alas» — el sobrevuelo**: es literalmente la pasada de homenaje del guion | no |
