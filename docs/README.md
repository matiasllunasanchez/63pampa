...
| [SPEC_TRAMOS.md](sistemas/SPEC_TRAMOS.md) | 🟥 **TRAMOS**: el guion de spawn por misión — segmentos por fracción con densidad, mezcla (`favor`), bidones y radio propios. 5 RF, sondas (`__trdbg`/`__trset`), fixture `npm run tramos`, fases T0–T4 (T4 = el tránsito del Narwal en M4) | **spec — listo para implementar** |
