...
| [PLAN_HORNEADO.md](sistemas/PLAN_HORNEADO.md) | 🟥 **el horneado**: todo lo que conviene pasar por low poly → sprite. B0 el horno unificado (luz/cámara/paleta + cajas medidas solas), B1 los restos, B2 los buques del pasillo (builders compartidos con `ship3d`), B3 el Harrier propio, B4 props de terreno, B5 partes v2, B6 aviones, B7 soldados y munición. Relevamiento del pipeline real (modelos procedurales, 4 horneadores) | **plan — sin implementar** |
