...
| [PROMPTS_PLACAS_LISTOS.md](historia/PROMPTS_PLACAS_LISTOS.md) | 🟩 **los 25 prompts de placas YA ENSAMBLADOS** — se copia y se pega. **Generado**: `python3 tools/hacer_prompts_prologo.py` |
| [PROMPTS_VN_PROLOGO.md](historia/PROMPTS_VN_PROLOGO.md) | la bajada operativa del prólogo: placas + figuras + retratos, con el sistema de TRES NIVELES (placa vacía / compuesta por el motor / horneada) y las cuatro reglas de las figuras |
| [PROMPTS_VN_PROLOGO_LISTOS.md](historia/PROMPTS_VN_PROLOGO_LISTOS.md) | 🟩 **los 24 prompts del prólogo YA ENSAMBLADOS** — bloque de estilo adentro, nombre de archivo por asset, se copia y se pega. **Generado**: `python3 tools/hacer_prompts_prologo.py` |
...
| [COMO_PROBAR.md](proyecto/COMO_PROBAR.md) | 🟥 **el catálogo de features con la forma más corta de probar cada una** (10 fixtures npm, ~80 sondas, 9 parámetros de URL — todo relevado) + **el plan del modo PRUEBAS** (fila del menú: catálogo de momentos elegibles, sin ensuciar récords ni saves, fases PR0–PR4) | **modo PRUEBAS: PR0 + PR1 hechos (19/8) — 20 momentos elegibles; PR3 la cerró el selector (S2); faltan PR2 y PR4** |
